    ...
    def start_data_validaton(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        try:
            if data_ingestion_artifact is None:
                logging.error("Data ingestion artifact is None. Data ingestion might have failed.")
                raise SensorException("Data ingestion artifact is missing.", sys)

            logging.info(f"Starting data validation with artifact: {data_ingestion_artifact}")
            ...
            logging.error(f"Error in start_data_validaton: {e}")
            raise SensorException(e, sys)
