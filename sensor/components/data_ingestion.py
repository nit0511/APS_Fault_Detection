...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        """
        Export MongoDB collection record as a DataFrame into the feature store
        """
        try:
            ...
            logging.info(f"Data Exported. Shape: {dataframe.shape}")
            ...
            logging.info(f"Saving feature store data to {feature_store_file_path}")
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        """
        Feature store dataset will be split into train and test files
        """
        try:
